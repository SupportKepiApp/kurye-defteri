...
export function Paywall({ open, onClose, trialDaysLeft, subDaysLeft = 0, subscriptionState, onSelectPlan, onRestore, loading = false, forceOpen = false, isDev = false }: PaywallProps) {
      ...
      <div className="slide-down relative mt-0 w-full max-w-md overflow-y-auto no-scrollbar" onTouchStart={handleTouchStart} onTouchMove={handleTouchMove}>
        <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white pt-6 dark:from-slate-900 dark:to-slate-950">
          ...
          <div className="flex flex-col items-center px-6 pb-6">
            ...
            {isDev && (
              <div className="mt-4 w-full rounded-xl bg-green-100 p-3 text-center text-green-700 dark:bg-green-900/30 dark:text-green-400">
                <p className="text-sm font-semibold">Geliştirici Hesabı — Sınırsız Premium</p>
              </div>
            )}

            {subscriptionState === "active" && !isDev && (
