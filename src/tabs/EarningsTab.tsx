      ...
      {showAdvanced && (
        <div className="fade-in card space-y-3">
          <div>
            ...
            <input type="number" inputMode="decimal" className="input" placeholder="0" value={ozet.calisma_saati || ""} onChange={(e) => patchOzet({ calisma_saati: parseFloat(e.target.value) || 0 })} />
